...
**Codex Agent Runner — AI code generation pipeline with distributed Ollama inference. Fleet proxy across 4 Pi nodes, task execution, validation, and static frontend.**
